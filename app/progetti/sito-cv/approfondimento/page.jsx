...
export const metadata = {
  title: "Approfondimento Tecnico – Sito CV | Simone Sugliano",
  description:
    "Approfondimento tecnico del sito CV: animazioni custom, layout responsive, design creativo e logiche interattive JavaScript.",
  alternates: { canonical: "/progetti/sito-cv/approfondimento" },
};
    ...
    <main className="max-w-[1200px] mx-auto text-white bg-black px-6 py-20">
      ...
      <header className="section-fade text-center mb-16">
        <h1 className="text-4xl font-extrabold mb-4">
          Approfondi<wbr />mento Tecnico – <span className="text-[#39FF14]">Sito-CV</span>
        </h1>
