...
export const metadata = {
  title: "Approfondimento Tecnico – E-commerce Metal | Simone Sugliano",
  description:
    "Approfondimento tecnico dell’E-commerce Metal: struttura prodotti, gestione componenti, ottimizzazione layout e performance.",
  alternates: { canonical: "/progetti/e-commerce/approfondimento" },
};
    ...
    <main className="max-w-[1200px] mx-auto text-white bg-black px-6 py-20">
      ...
      <header className="section-fade text-center mb-16">
        <h1 className="text-4xl font-extrabold mb-4">
          Approfondi<wbr />mento Tecnico – <span className="text-[#39FF14]">E commerce - Metal</span>
        </h1>
