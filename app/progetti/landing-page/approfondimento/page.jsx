...
export const metadata = {
  title: "Approfondimento Tecnico – Landing Page Marketing | Simone Sugliano",
  description:
    "Analisi tecnica della landing marketing: struttura semantica, ottimizzazione SEO, microcopy e logiche di conversione.",
  alternates: { canonical: "/progetti/landing-page/approfondimento" },
};
    ...
    <main className="max-w-[1200px] mx-auto text-white bg-black px-6 py-20">
      ...
      <header className="section-fade text-center mb-16">
        <h1 className="text-4xl font-extrabold mb-4">
          Approfondi<wbr />mento Tecnico – <span className="text-[#39FF14]">Landing Page</span>
        </h1>
